...
if __name__ == "__main__":
    ...
    pose_initial_to_result_ndt_list = list()
    ekf_pose_list = list()
    ...
    while reader.has_next():
        ...
        if topic == "/localization/pose_estimator/initial_to_result_relative_pose":
            pose = msg.pose
            pose_initial_to_result_ndt_list.append({
    ...
    save_dir = (rosbag_path.parent if rosbag_path.is_dir() else rosbag_path.parent.parent) / "pose_initial_to_result_ndt"
    save_dir.mkdir(exist_ok=True)

    # plot pose_initial_to_result_ndt
    plt.plot(df_pose_initial_to_result_ndt['timestamp'],
             df_pose_initial_to_result_ndt['x'], label='x')
    plt.plot(df_pose_initial_to_result_ndt['timestamp'],
             df_pose_initial_to_result_ndt['y'], label='y')
    plt.plot(df_pose_initial_to_result_ndt['timestamp'],
             df_pose_initial_to_result_ndt['z'], label='z')
    ...
    diff_pose = df_pose_initial_to_result_ndt[['x', 'y', 'z']].values
