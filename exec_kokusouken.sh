...
# 保存
SAVE_DIR=$HOME/data/misc/$(date +"%Y%m%d_%H%M%S")_general_logging
./record_localization_result.sh $SAVE_DIR &
...
# 評価
python3 /home/shintarosakoda/misc/local_script/parse_rosbag_ekf_compare.py $SAVE_DIR /home/shintarosakoda/data/misc/ekf_20231114_205333_ndt
